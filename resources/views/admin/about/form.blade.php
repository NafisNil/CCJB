                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputFile">Cover Image <span style="color:red" >*</span></label>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="youtube link" name="video" value="{!!old('video',@$edit->video)!!}">
